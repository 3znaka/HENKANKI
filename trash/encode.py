...
def create_aztec_code(data, output_path):
    """Создает Aztec код из данных и сохраняет его в output_path."""
    aztec = AztecCode(data, ec_percent=30)
    aztec.save(output_path)
...
def main(file_path):
    ...
    for chunk_number, chunk in enumerate(chunks):
        ...
        output_path = os.path.join(output_dir, f"aztec_code_{chunk_number}.png")
        create_aztec_code(chunk_base64, output_path)
